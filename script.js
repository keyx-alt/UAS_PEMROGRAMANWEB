...
const TOOLS = {
  "Networking":[
    ...
    {name:"tcpdump",   func:"Command-line packet capture", diff:3, use:"Headless server, scripting, quick capture", pros:"Ringan, scriptable, tersedia hampir di semua sistem", cons:"Tidak ada GUI, learning curve cukup tinggi", url:"https://tcpdump.org", url1:"pages/coming-soon.html"}
  ],
  "Web Security":[
    ...
    {name:"OWASP ZAP",  func:"Open-source web application scanner", diff:2, use:"Automated scanning, spidering, analisis pasif", pros:"Gratis, dikembangkan aktif, bagus untuk pemula", cons:"Lebih banyak false positives vs Burp Pro", url:"https://zaproxy.org", url1:"pages/coming-soon.html"}
  ],
  "Forensics":[
